    ...
    <div class="sf-dflex sf-flex-col sf-mx-auto sf-mt-3 ">
        ...
        <div class="sf-dflex sf-mx-auto sf-mt-6 sf-p-sm-2 sf-p-md-0">
            <div class="sf-box_shadox-1 sf-br-1 sf-dflex sf-flex-col  sf-w30 sf-w-xs-10 sf-w-md-5  sf-w-lg-4  sf-mx-auto sf-p-1"
                ...
                <div class="sf-fs-2 sf-fw-6 text-center sf-mt-2">Refonte de site</div>
                ...
                <div class="sf-mx-auto ">
                    <a class="sf-btn sf-btn-bg-bprimary sf-mx-auto  sf-br-2 sf-mt-2" href="refont.html">
            ...
            <div class="sf-box_shadox-1 sf-br-1 sf-dflex sf-flex-col sf-mt-xs-6 sf-mt-md-0 sf-w30 sf-w-xs-10  sf-w-md-5  sf-w-lg-4 sf-mx-auto sf-p-1"
                style="background-color: #d6cece;">
                <div class="sf-fs-2 sf-fw-6 text-center sf-mt-2">Sites web</div>
                <div class="sf-shadow-inset sf-mx-auto sf-p-1 sf-br-1 sf-mt-2" style="background-color: white;">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa hic debitis officia
                    repellendus? Maxime, facere quaerat, distinctio nostrum similique incidunt natus quis
                    doloremque corrupti nihil nemo, rerum totam nisi architecto!
                ...
                <div class="sf-mx-auto ">
                    <a class="sf-btn sf-btn-bg-bprimary sf-mx-auto  sf-br-2 sf-mt-2" href="site.html">
                        Consulter <i class="fa-solid fa-arrow-right"></i></a>
        ...
        <div class="sf-dflex sf-mx-auto sf-p-sm-2 sf-p-md-0 sf-mt-6">

            <div class="sf-box_shadox-1 sf-br-1 sf-dflex sf-flex-col   sf-w-xs-10  sf-w-md-5  sf-w-lg-4  sf-mx-auto sf-p-1"
                style="background-color: #d6cece;">
                <div class="sf-fs-2 sf-fw-6 text-center sf-mt-2">Sites E-commerce</div>
                <div class="sf-shadow-inset sf-mx-auto sf-p-1 sf-br-1 sf-mt-2" style="background-color: white;">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa hic debitis officia
                    repellendus? Maxime, facere quaerat, distinctio nostrum similique incidunt natus quis
                    doloremque corrupti nihil nemo, rerum totam nisi architecto!
                ...
                <div class="sf-mx-auto ">
                    <a class="sf-btn sf-btn-bg-bprimary sf-mx-auto  sf-br-2 sf-mt-2" href="ecommerce.html">
                        Consulter <i class="fa-solid fa-arrow-right"></i></a>

                </div>
            </div>
            <div class="sf-box_shadox-1 sf-br-1 sf-dflex sf-flex-col  sf-mt-xs-6 sf-mt-md-0 sf-w-xs-10  sf-w-md-5  sf-w-lg-4  sf-mx-auto sf-p-1"
                style="background-color: #d6cece;">
                <div class="sf-fs-2 sf-fw-6 text-center sf-mt-2">Applications mobiles</div>
                <div class="sf-shadow-inset sf-mx-auto sf-p-1 sf-br-1 sf-mt-2" style="background-color: white;">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa hic debitis officia
                    repellendus? Maxime, facere quaerat, distinctio nostrum similique incidunt natus quis
                    doloremque corrupti nihil nemo, rerum totam nisi architecto!
                ...
                <div class="sf-mx-auto ">
                    <a class="sf-btn sf-btn-bg-bprimary sf-mx-auto  sf-br-2 sf-mt-2" href="applis.html">
                        Consulter <i class="fa-solid fa-arrow-right"></i></a>
